...
alias youtube='python3 youtube.py'
alias chatgpt='python3 chatgpt.py'
alias pornhub='python3 pornhub.py'

[ -f "/home/giviko/.ghcup/env" ] && source "/home/giviko/.ghcup/env" # ghcup-envexport JAVA_HOME=/usr/bin/java/
...
alias reddit='python3 reddit.py'
alias unixporn='python3 unixporn.py'
